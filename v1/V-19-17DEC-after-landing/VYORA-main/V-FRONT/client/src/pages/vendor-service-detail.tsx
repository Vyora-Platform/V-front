        ...
        <div>
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              <h1 className="text-2xl sm:text-3xl font-bold" data-testid="text-service-name">{service.name}</h1>
              {serviceData.tagline && (
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className="flex items-baseline gap-3">
                {hasOfferPrice ? (
                  <>
                    <span className="text-3xl font-bold text-primary" data-testid="text-service-price">
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          {!serviceData.shortDescription && !serviceData.detailedDescription && service.description && (
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed" data-testid="text-service-description">
                {service.description}
              </p>
            </div>
          )}
            ...
            <div>
              ...
              <div className="grid gap-3">
                {serviceData.packages.map((pkg: any, idx: number) => (
                  <Card key={idx} className="p-4" data-testid={`card-package-${idx}`}>
        ...
        {serviceData.termsAndConditions && (
          <>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground whitespace-pre-wrap bg-muted/50 p-4 rounded-lg" data-testid="text-terms">
                {serviceData.termsAndConditions}
              </p>
            </div>
          </>
