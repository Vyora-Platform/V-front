...
import type { InsertTask, Employee } from "@shared/schema";

import { useAuth } from "@/hooks/useAuth";
import { LoadingSpinner } from "@/components/AuthGuard";

export default function VendorTasksCreate() {
  ...
  const createTaskMutation = useMutation({
    mutationFn: async (data: InsertTask) => {
      return await apiRequest("POST", `/api/vendors/${vendorId}/tasks`, data);
    },
    onSuccess: () => {
  ...
  return (
    <div className="container mx-auto p-3 sm:p-4 md:p-6 pb-16 md:pb-6 max-w-3xl">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-bold" data-testid="heading-create-task">
            Create New Task
          </h1>
          <p className="text-muted-foreground">Add a new task with reminders and priorities</p>
        </div>
      </div>
